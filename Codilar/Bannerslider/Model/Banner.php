...
{
    const BASE_MEDIA_PATH = 'codilar/bannerslider/images';

    const BANNER_TARGET_SELF = 0;
    const BANNER_TARGET_PARENT = 1;
    const BANNER_TARGET_BLANK = 2;

    const BANNER_DEVICE_SELF = 0;
    const BANNER_DEVICE_MOBILE = 1;
    const BANNER_DEVICE_TAB = 2;
    /**
     ...
     * value factory.
     *
     * @var \Codilar\Bannerslider\Model\ValueFactory
     */
     ...
     * @param \Codilar\Bannerslider\Model\ResourceModel\Banner                   $resource
     * @param \Codilar\Bannerslider\Model\ResourceModel\Banner\Collection        $resourceCollection
    ...
    public function __construct(
        ...
        \Codilar\Bannerslider\Model\ResourceModel\Banner $resource,
        \Codilar\Bannerslider\Model\ResourceModel\Banner\Collection $resourceCollection,
        \Codilar\Bannerslider\Model\BannerFactory $bannerFactory,
        \Codilar\Bannerslider\Model\ValueFactory $valueFactory,
...
//    }
    ...
    public function getDeviceValue()
    {
        switch ($this->getDevice()) {
            case self::BANNER_DEVICE_SELF:
                return '_self';
            case self::BANNER_DEVICE_MOBILE:
                return '_parent';
            case self::BANNER_DEVICE_TAB:
                return '_parent';
            default:
                return '_blank';
        }
