 ...
 */
namespace Codilar\Bannerslider\Block\Adminhtml\Report;
use Codilar\Bannerslider\Model\ResourceModel\Report\Collection as ReportCollection;
/**
 * Report grid.
 * @category Codilar
 * @package  Codilar_Bannerslider
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \Codilar\Bannerslider\Model\ResourceModel\Report\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'index' => 'imagename',
                'renderer' => 'Codilar\Bannerslider\Block\Adminhtml\Report\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'date_click',
