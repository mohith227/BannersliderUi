 ...
 */
class ExportCsv extends \Codilar\Bannerslider\Controller\Adminhtml\Slider
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Codilar\Bannerslider\Block\Adminhtml\Slider\Grid')->getCsv();
