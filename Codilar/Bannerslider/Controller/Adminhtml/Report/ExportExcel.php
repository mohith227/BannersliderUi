 ...
 */
class ExportExcel extends \Codilar\Bannerslider\Controller\Adminhtml\Report
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Codilar\Bannerslider\Block\Adminhtml\Report\Grid')->getExcel();
