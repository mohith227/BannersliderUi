 ...
 */
class ExportXml extends \Codilar\Bannerslider\Controller\Adminhtml\Banner
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Codilar\Bannerslider\Block\Adminhtml\Banner\Grid')->getXml();
