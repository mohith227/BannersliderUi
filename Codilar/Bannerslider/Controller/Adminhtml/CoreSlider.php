...
namespace Codilar\Bannerslider\Controller\Adminhtml;
 ...
 */
abstract class CoreSlider extends \Codilar\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Codilar_Bannerslider::bannerslider_coreslider');
    }
}
