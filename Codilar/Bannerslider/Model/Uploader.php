...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'bannerslideradmin/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'bannerslideradmin/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'bannerslideradmin/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'bannerslideradmin/images/file';
